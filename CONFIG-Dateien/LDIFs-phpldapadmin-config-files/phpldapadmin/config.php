...
$servers->setValue('server','name','LDAP Server vmLS4');
...
$servers->setValue('server','base',array('dc=m159,dc=iet-gibb,dc=ch'));
...
/* The DN of the user for phpLDAPadmin to bind with. For anonymous binds or
   ...
   binds. */
$servers->setValue('login','bind_id','cn=admin,dc=m159,dc=iet-gibb,dc=ch');
